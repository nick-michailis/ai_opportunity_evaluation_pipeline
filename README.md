...
Business process submitted via webhook

Payload normalization

AI opportunity analysis (structured JSON output)

Weighted scoring logic

Pipeline tracking (Google Sheets)

Executive HTML report generation

Automated PDF creation

Execution proof in n8n
...
<img width="1000" src="ai-opportunity-assessment-pdf.png" />
